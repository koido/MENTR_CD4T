...
do
  ...
  do
    ...
    Rscript ./cd4t/src/R/calc_pred_accuracy_allowmissingExpr_cross.R \
      ...
      --truth_file ${OUT}/gbtree_logistic_sample_name.${in_sample2}_filterStr.all_num_round.500_early_stopping_rounds.10_base_score.0.5_l1.0_l2.50_eta.0.01_seed.12345_max_depth.4_evalauc_type.test_expr_pred_c.txt.gz \
      --col_types ciccdd \
